...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    @IBInspectable var selectedLabelColor : UIColor = Constants.Colors.mainLightBlueColor {
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var unselectedLabelColor : UIColor = Constants.Colors.mainLightBlueColor {
        didSet {
            setSelectedColors()
        }
    }
